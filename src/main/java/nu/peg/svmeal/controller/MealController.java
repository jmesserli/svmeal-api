...
public class MealController {
  ...
  public Response<MealPlanDto> getRestaurantMeal(
  ...
  public Response<MealPlanDto> getRestaurantMealOffset(
      @PathVariable("restaurant") String restaurantString,
  ...
  public Response<AvailabilityDto> getMealPlanAvailability(
      @PathVariable("restaurant") String restaurantString,
      @PathVariable("dayOffset") int dayOffset) {
    Optional<SvRestaurant> restaurant = findRestaurant(restaurantString);
